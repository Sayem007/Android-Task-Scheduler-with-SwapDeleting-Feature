...
A sample android SQL based Task Scheduler which is allowed to add new task entry and delete them. It also shows the saved date of every item in the listview. The items can easily be deleted by swaping left or right.
## Preview
